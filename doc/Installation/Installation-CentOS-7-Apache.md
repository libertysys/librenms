...
## Install Required Packages ##
    ...
    yum install composer mariadb-server mariadb php71w php71w-cli php71w-gd php71w-mysql php71w-snmp php71w-pear php71w-curl php71w-common php71w-zip httpd net-snmp ImageMagick jwhois nmap mtr rrdtool MySQL-python python-memcached net-snmp-utils cronie php71w-mcrypt fping
